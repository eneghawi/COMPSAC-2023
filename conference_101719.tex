...
\end{itemize}
An excellent style manual for science writers is \cite{LaineA16}.
...
Please number citations consecutively within brackets \cite{LaineA16}. The 
sentence punctuation follows the bracket \cite{LaineA16}. Refer simply to the reference 
number, as in \cite{LaineA16}---do not use ``Ref. \cite{LaineA16}'' or ``reference \cite{LaineA16}'' except at 
the beginning of a sentence: ``Reference \cite{LaineA16} was the first $\ldots$''
...
submitted for publication, should be cited as ``unpublished'' \cite{LaineA16}. Papers 
that have been accepted for publication should be cited as ``in press'' \cite{LaineA16}. 
Capitalize only the first word in a paper title, except for proper nouns and 
element symbols.

For papers published in translation journals, please give the English 
citation first, followed by the original foreign-language citation \cite{LaineA16}.
